                    ...
                    return (
                        a(e, [
                            ...
                            },
                            {
                                key: "_updateAltField",
                                value: function(e) {
                                    var t = this.model.options.altFieldFormatter(
                                        e
                                    );
                                ...
                                value: function(e) {
                                    if (
                                        ...
                                        "meridian" == e
                                            ...
                                            (this.scrollDelayTimeUp = setTimeout(
                                                function() {
                                ...
                                value: function(e) {
                                    if (
                                        ...
                                        "meridian" == e
                                            ...
                                            (this.scrollDelayTimeDown = setTimeout(
                                                function() {
                                                    n.model.view.markSelectedDay();
                                                },
                                                300
                ...
                o = (function() {
                    function e(t) {
                        return (
                            ...
                            (this.model.options.locale_ = this.model.options.calendar[
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    this.viewModeList.indexOf(e) >= 0 &&
                                        ((this.viewMode = e),
                                        (this.viewModeIndex = this.viewModeList.indexOf(
                                            e
                                        )));
                                }
                            },
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    return (
                                        ...
                                        (this.view.hour12 = this.view.dateObject.format(
                                            "hh"
                                        )),
                                ...
                                value: function() {
                                    ...
                                    "persian" == e.model.options.calendar_
                                        ? ((e.model.options.calendar_ =
                                              "gregorian"),
                                          (e.model.options.locale_ = this.model.options.calendar.gregorian.locale))
                                        : ((e.model.options.calendar_ =
                                              "persian"),
                                          (e.model.options.locale_ = this.model.options.calendar.persian.locale));
                                }
                            },
                            {
                                key: "_attachEvents",
                    ...
                    return (
                        s(e, [
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    if (this.model.state.filetredDate) {
                                        var t = this.model.state.filterDate
                                                .start.year,
                                            i = this.model.state.filterDate.end
                                                .year;
                                        if (t && e < t) return !1;
                                        if (i && e > i) return !1;
                                    }
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    var t = this,
                                        i = this.model.options.yearPicker
                                            .enabled;
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    ...
                                    if (this.model.state.filetredDate) {
                                        var i = this.model.state.filterDate
                                                .start.month,
                                            n = this.model.state.filterDate.end
                                                .month,
                                            a = this.model.state.filterDate
                                                .start.year,
                                            o = this.model.state.filterDate.end
                                                .year;
                                        if (
                                            (i &&
                                                n &&
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    var e = this.model.options.monthPicker
                                        .enabled;
                                ...
                                value: function(e) {
                                    ...
                                    if (
                                        ...
                                        if (t.minDate && t.maxDate) {
                                            if (
                                                ((t.minDate = t.model.PersianDate.date(
                                                    t.minDate
                                                )
                                                    .startOf("day")
                                                    .valueOf()),
                                                (t.maxDate = t.model.PersianDate.date(
                                                    t.maxDate
                                                )
                                                    .endOf("day")
                                                    .valueOf()),
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    if ("day" != this.model.state.viewMode)
                                        return [];
                                    var e = this.model.options.dayPicker
                                        .enabled;
                                    if (!e) return { enabled: !1 };
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    var e = this.model.options.timePicker
                                        .enabled;
                                    if (!e) return { enabled: !1 };
                                    var t = void 0;
                                    return (
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    ...
                                    return {
                                        ...
                                        onlyTimePicker: this.model.options
                                            .onlyTimePicker,
                                        altCalendarShowHint: this.model.options
                                            .calendar[t[0]].showHint,
                                        ...
                                        todayButtonText: this._getButtonText()
                                            .todayButtontext,
                                        submitButtonText: this._getButtonText()
                                            .submitButtonText
                                    };
                                }
                            },
                                ...
                                value: function() {
                                    ...
                                    return (
                                        "fa" == this.model.options.locale_
                                            ? ((e.todayButtontext = this.model.options.toolbox.todayButton.text.fa),
                                              (e.submitButtonText = this.model.options.toolbox.submitButton.text.fa))
                                            : "en" ==
                                                  this.model.options.locale_ &&
                                              ((e.todayButtontext = this.model.options.toolbox.todayButton.text.en),
                                              (e.submitButtonText = this.model.options.toolbox.submitButton.text.en)),
                                        e
                                    );
                                }
                            },
            ...
            !(function(i, s) {
                ...
                function d(t, i) {
                    ...
                    var o,
                        ...
                        w = !1;
                    a(i || e.tags);
                    for (var y, b, T, M, O, S, E = new h(t); !E.eos(); ) {
