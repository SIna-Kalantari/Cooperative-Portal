                        ...
                        r(
                            ...
                            [
                                ...
                                },
                                {
                                    key: "_weekNameShort",
                                    value: function(e) {
                                        return this._locale().weekdaysShort[
                                            e - 1
                                        ];
                                    }
                                },
                                {
                                    key: "_weekNameMin",
                                    value: function(e) {
                                        return this._locale().weekdaysMin[
                                            e - 1
                                        ];
                                    }
                                },
                                {
                                    key: "_dayName",
                                    value: function(e) {
                                        return this._locale().persianDaysName[
                                            e - 1
                                        ];
                                    }
                                },
                                ...
                                },
                                {
                                    key: "_monthNameShort",
                                    value: function(e) {
                                        return this._locale().monthsShort[
                                            e - 1
                                        ];
                                    }
                                },
                                        ...
                                        return (
                                            ...
                                            "algorithmic" === this.leapYearMode
                                                ...
                                                : "persian" ==
                                                  ...
                                                  "astronomical" ===
                                                      this.leapYearMode
                                                ? this.algorithms.leap_persiana(
                                                      e
                                                  )
                                                : "gregorian" ==
                                                  this.calendarType
                                                ? this.algorithms.leap_gregorian(
                                                      e
                                                  )
                                                : void 0
                                        );
                                            ...
                                            "_default" === this.formatPersian
                                                ? (t =
                                                      ...
                                                      void 0 !== e.exports
                                                          ? a.formatPersian !==
                                                            !1
                                                          : window.formatPersian !==
                                                            !1)
                                                : this.formatPersian === !0
                                                ? (t = !0)
                                                : this.formatPersian === !1
                                                ? (t = !1)
                                                : Error(
                    ...
                    return (
                        r(e, [
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    ...
                                    return (
                                        (r =
                                            Math.round(
                                                (a - this.PERSIAN_EPOCH) /
                                                    this.ASTRO.TropicalYear
                                            ) + 1),
                                        [r, a]
                                    );
                                }
                                ...
                                value: function() {
                                    ...
                                    (t = this.ON.gregorian.year),
                                        ...
                                        "persian" == this.parent.calendarType &&
                                            ...
                                            (this.ON.persianAstro.weekday = this.gWeekDayToPersian(
                                                o
                                            )),
                                            (this.ON.persianAstro.leap = this.NormLeap[
                                                this.leap_persiana(u[0]) ? 1 : 0
                                            ])),
                                        null !== this.ON.gregserial.day &&
                                            (this.ON.gregserial.day =
                                                e - this.J0000),
                                        (h = 864e5 * (e - this.J1970)),
                                        (this.ON.unixtime = Math.round(
                                            h / 1e3
                                        ));
                                }
                            },
                            {
                                ...
                                value: function(e) {
                                    (e[0] || 0 === e[0]) &&
                                        (this.ON.gregorian.year = e[0]),
                                        (e[1] || 0 === e[1]) &&
                                            (this.ON.gregorian.month = e[1]),
                                        (e[2] || 0 === e[2]) &&
                                            (this.ON.gregorian.day = e[2]),
                                        (e[3] || 0 === e[3]) &&
                                            (this.ON.gregorian.hour = e[3]),
                                        (e[4] || 0 === e[4]) &&
                                            (this.ON.gregorian.minute = e[4]),
                                        (e[5] || 0 === e[5]) &&
                                            (this.ON.gregorian.second = e[5]),
                                        (e[6] || 0 === e[6]) &&
                                            (this.ON.gregorian.millisecond =
                                                e[6]),
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    e[0] && (this.ON.persianAstro.year = e[0]),
                                        e[1] &&
                                            (this.ON.persianAstro.month = e[1]),
                                        e[2] &&
                                            (this.ON.persianAstro.day = e[2]),
                                        e[3] && (this.ON.gregorian.hour = e[3]),
                                        e[4] &&
                                            (this.ON.gregorian.minute = e[4]),
                                        e[5] &&
                                    ...
                                    for (o = u / 10, i = 0; i < 63; i++) {
                                        for (h = 0, r = 0; r < 5; r++)
                                            0 !== this.nutArgMult[5 * i + r] &&
                                                (h +=
                                                    this.nutArgMult[5 * i + r] *
                                                    d[r]);
                                        (l +=
                                            (this.nutArgCoeff[4 * i + 0] +
                                                this.nutArgCoeff[4 * i + 1] *
                                                    o) *
                                            Math.sin(h)),
                                            (c +=
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    ...
                                    return (
                                        ...
                                        (v = this.rtd(
                                            Math.asin(
                                                this.dsin(y) * this.dsin(o)
                                            )
                                        )),
                                        (m = this.rtd(
                                            Math.atan2(
                                                this.dcos(c) * this.dsin(l),
                                                this.dcos(l)
                                            )
                                        )),
                                        (m = this.fixangle(m)),
