!(function(a, b) {
    function c(b) {
        ...
        if (
            ...
            switch ((w(j), b.type)) {
                case "success":
                    s(j, "animate"),
                        s(j.querySelector(".tip"), "animateSuccessTip"),
                        s(j.querySelector(".long"), "animateSuccessLong");
                    break;
                case "error":
                    s(j, "animateErrorIcon"),
                        s(j.querySelector(".x-mark"), "animateXMark");
                    break;
                case "warning":
                    s(j, "pulseWarning"),
                        s(j.querySelector(".body"), "pulseWarningIns"),
                        s(j.querySelector(".dot"), "pulseWarningIns");
            }
        }
        if (b.imageUrl) {
        ...
        c.setAttribute("data-has-done-function", r),
            c.setAttribute("data-timer", b.timer);
    }
    function d(a, b) {
    ...
    function f() {
        ...
        t(d, "animate"),
            t(d.querySelector(".tip"), "animateSuccessTip"),
            t(d.querySelector(".long"), "animateSuccessLong");
        ...
        t(f, "pulseWarning"),
            t(f.querySelector(".body"), "pulseWarningIns"),
            t(f.querySelector(".dot"), "pulseWarningIns"),
            (a.onkeydown = j),
            (b.onclick = i),
            h && h.focus(),
            (k = void 0);
    ...
    var h,
        ...
        A = function(a) {
            ...
            var b = a.clientHeight,
                c = parseInt(
                    getComputedStyle(a).getPropertyValue("padding"),
                    10
                );
            return (
                (a.style.left = ""),
    ...
    (a.sweetAlertInitialize = function() {
        ...
        (a.sweetAlert = a.swal = function() {
            function h(a) {
                ...
                if (-1 !== [9, 13, 32, 27].indexOf(b)) {
                    for (
                        var c = a.target || a.srcElement, d = -1, e = 0;
                        e < w.length;
                        e++
                    )
                        if (c === w[e]) {
            ...
            if (void 0 === arguments[0])
                return (
                    a.console.error("sweetAlert expects at least 1 attribute!"),
                    !1
                );
            var m = d({}, o);
            switch (typeof arguments[0]) {
                ...
                case "object":
                    if (void 0 === arguments[0].title)
                        return a.console.error('Missing "title" argument!'), !1;
                    (m.title = arguments[0].title),
                        ...
                        (m.showCancelButton =
                            void 0 !== arguments[0].showCancelButton
                                ...
                                : o.showCancelButton),
                        (m.showConfirmButton =
                            void 0 !== arguments[0].showConfirmButton
                        ...
                        (m.confirmButtonText = o.showCancelButton
                            ? "Confirm"
                            : o.confirmButtonText),
                        (m.confirmButtonText =
                            arguments[0].confirmButtonText ||
                            o.confirmButtonText),
                        (m.confirmButtonClass =
                            arguments[0].confirmButtonClass ||
                            (arguments[0].type
                                ? "btn-" + arguments[0].type
                                : null) ||
                        ...
                        (m.cancelButtonClass =
                            ...
                            o.cancelButtonClass),
                        (m.containerClass =
                            arguments[0].containerClass || o.containerClass),
                        (m.titleClass =
                            arguments[0].titleClass || o.titleClass),
                    ...
                    q = function(a) {
                        var b = a.target || a.srcElement,
                            ...
                            e =
                                m.doneFunction &&
                                "true" ===
                                    n.getAttribute("data-has-done-function");
                        switch (a.type) {
                            case "click":
                                if (c && e && d)
                                    m.doneFunction(!0), m.closeOnConfirm && f();
                                else if (e && d) {
                                    var g = String(m.doneFunction).replace(
                                            /\s/g,
                                            ""
                                        ),
                                        h =
                                            "function(" === g.substring(0, 9) &&
                                            ")" !== g.substring(9, 10);
                                    h && m.doneFunction(!1),
                                        m.closeOnCancel && f();
                                } else f();
            ...
            (i = b.onclick),
                (b.onclick = function(a) {
                    var b = a.target || a.srcElement,
                        ...
                        g =
                            "true" ===
                            n.getAttribute("data-allow-ouside-click");
                    !c && !d && e && g && f();
                });
        ...
        (function() {
            ...
            ("interactive" === b.readyState && b.body)
                ...
                : b.attachEvent &&
                  b.attachEvent("onreadystatechange", function c() {
                      "complete" === b.readyState &&
                          (b.detachEvent("onreadystatechange", c),
                          sweetAlertInitialize());
                  });
        })();
})(window, document);
